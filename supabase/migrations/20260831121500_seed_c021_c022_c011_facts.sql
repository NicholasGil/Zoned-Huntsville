-- C-021 / C-022 leftover sourced facts. Do not rewrite 20260830120100.
-- Mirrors LEFTOVER_S2_FACTS in lib/c021-c022-facts.ts.
-- C-011 legal copy lives in app/legal; this migration is facts only.
...
insert into public.facts (
  ...
  (
    ...
    'https://hstigers.org/career-opportunities/',
    '2026-08-31',
    'official_page'
  ),
  (
  ...
  (
    ...
    'https://hstigers.org/prospective-parents/',
    '2026-08-31',
    'official_page'
  ),
  (
    ...
    'https://hstigers.org/tuition-scholarships/',
    '2026-08-31',
    'official_page'
  ),
  (
    ...
    'https://www.randolphschool.net/admissions/',
    '2026-08-31',
    'official_page'
  ),
  (
  ...
  (
    ...
    'grades',
    'K4-8th grade',
    'https://www.stjohnb.com/admit.html',
    '2026-08-31',
    'official_page'
  ),
  (
  ...
  (
    ...
    'https://www.gls-hsv.org/how-to-apply/',
    '2026-08-31',
    'official_page'
  ),
  (
