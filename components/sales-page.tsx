  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-6 py-16 sm:py-24">
      ...
      <section aria-labelledby="hero-heading">
        ...
        <h1
          id="hero-heading"
          className="mt-5 max-w-3xl font-sans text-4xl leading-tight text-text sm:text-5xl"
        >
          {hero.headline}
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-text-muted">{hero.subhead}</p>
        ...
        <div className="mt-8">
          <p className="font-sans text-3xl text-text">$79</p>
          <CheckoutForm
            tierId="79"
            label={hero.cta}
            variant="brick"
            className="mt-4"
          />
          <p className="mt-3 text-sm text-text-muted">{hero.guarantee}</p>
        </div>
      </section>

      <section aria-labelledby="problem-heading" className="mt-20">
        <h2 id="problem-heading" className="font-sans text-2xl text-text">
          The problem
        </h2>
        <p className="mt-4 max-w-2xl leading-relaxed text-text-muted">{salesCopy.problem}</p>
      </section>

      <section aria-labelledby="free-guides-heading" className="mt-20">
        <h2 id="free-guides-heading" className="font-sans text-2xl text-text">
          Why free guides fail
        </h2>
        {salesCopy.whyFreeGuidesFail.map((paragraph) => (
          <p key={paragraph} className="mt-4 max-w-2xl leading-relaxed text-text-muted">
            {paragraph}
          </p>
        ))}
      </section>
      ...
      <section aria-labelledby="mechanism-heading" className="mt-20">
        <h2 id="mechanism-heading" className="font-sans text-2xl text-text">
          How this is built
        </h2>
        <p className="mt-4 max-w-2xl leading-relaxed text-text-muted">{salesCopy.mechanism}</p>
      </section>

      <section aria-labelledby="modules-heading" className="mt-20">
        <h2 id="modules-heading" className="font-sans text-2xl text-text">
          What&apos;s in the Guide
        </h2>
      ...
      <section aria-labelledby="sample-heading" className="mt-20">
        <h2 id="sample-heading" className="font-sans text-2xl text-text">
          Free sample
        </h2>
      ...
      <section aria-labelledby="who-heading" className="mt-20">
        <h2 id="who-heading" className="font-sans text-2xl text-text">
          Who built this
        </h2>
        <p className="mt-4 max-w-2xl leading-relaxed text-text-muted">{salesCopy.whoBuiltThis}</p>
      </section>

      <section aria-labelledby="objections-heading" className="mt-20">
        <h2 id="objections-heading" className="font-sans text-2xl text-text">
          Objections
        </h2>
        <dl className="mt-6 max-w-2xl space-y-8">
          {salesCopy.objections.map((item) => (
            <div key={item.question}>
              <dt className="font-sans text-xl text-text">{item.question}</dt>
              <dd className="mt-3 leading-relaxed text-text-muted">{item.answer}</dd>
            </div>
          ))}
        </dl>
      </section>
      ...
      <section aria-labelledby="guarantee-heading" className="mt-20">
        <h2 id="guarantee-heading" className="font-sans text-2xl text-text">
          Guarantee
        </h2>
        <p className="mt-4 max-w-2xl leading-relaxed text-text-muted">
      ...
      <section aria-labelledby="faq-heading" className="mt-20">
        <h2 id="faq-heading" className="font-sans text-2xl text-text">
          FAQ
        </h2>
        <dl className="mt-6 max-w-2xl space-y-8">
      ...
      <section aria-labelledby="final-cta-heading" className="mt-20 border-t border-border pt-16">
        <h2 id="final-cta-heading" className="font-sans text-2xl text-text">
          Get the Guide
        </h2>
        <p className="mt-4 font-sans text-3xl text-text">$79</p>
        <CheckoutForm
          tierId="79"
          label={hero.cta}
          variant="brick"
